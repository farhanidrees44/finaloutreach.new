...
const RESOURCES = [
  {
    ...
    desc: "Free PDF playbook covering deliverability, copy, sequencing, and measurement.",
    cta: "Download free",
  },
  {
    ...
    desc: "Cold email template angles and structures we use in live campaigns.",
  ...
  },
  {
    href: "/blog",
    icon: Mail,
    label: "Outbound blog & guides",
    desc: "Playbooks, deliverability notes, and outbound strategy deep-dives.",
    cta: "Read the blog",
  },
]
